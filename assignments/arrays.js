...
for (let i = 0; i < inventory.length; i++) {
  if (inventory[i] === inventory[32]) {
    carCheck.push(inventory[i]);
  }
}

console.log(`Car 33 is a ${carCheck[0].car_year} ${carCheck[0].car_make} ${carCheck[0].car_model}.`);
...
console.log(`The last car is a ${lastCar[0].car_year} ${lastCar[0].car_make} ${lastCar[0].car_model}.`);
